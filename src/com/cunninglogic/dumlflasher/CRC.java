...
public class CRC {
    ...
    private static int seed16 = 0x3692;
    ...
    public static int calc16 (byte[] packet) {
        int j = seed16;
        int len = packet.length;
        for (int i = 0; i < len; i++) {
            j = (j >> 8) ^ crc16[(j ^ packet[i]) & 0xFF];
        }
        return j;
    }
    ...
    public static byte[] pktCRC(byte[] packet) {
        ...
        byte[] crc = ByteBuffer.allocate(2).putShort((short)CRC.calc16(packet)).array();
